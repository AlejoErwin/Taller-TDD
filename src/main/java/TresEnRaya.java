public class TresEnRaya {
    ...
    public String jugar(int x,int y) throws Exception{
        ...
        if (hayGanador()) return ultimoJugador+" es el ganador";
    ...
    public void asignarPosicion(int x,int y,char ultimoJugador) throws Exception {
        if(tablero[x-1][y-1]!='0'){
            throw new Exception("La posicion ya esta ocupada");
        }
        else {
            tablero[x-1][y-1]=ultimoJugador;
            System.out.println("Ocupacion posicion: "+x+", "+y);
        }
    }
